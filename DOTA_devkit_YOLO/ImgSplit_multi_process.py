...
class splitbase():
    def __init__(self,
        ...
        """
        :param basepath: base path for dota data  ���ָ���ļ���
        :param outpath: output base path for dota data,  ����ָ�ͼƬ���ļ���
        the basepath and outputpath have the similar subdirectory, 'images' and 'labelTxt'
        :param code: encodeing format of txt file
        :param gap: overlap between two patches  ����ͼƬ֮����ص�
...
if __name__ == '__main__':
    ...
    split = splitbase(r'/home/liyuchen/YOLOX/YOLOX-OBB-main/datasets/DOTA_v1.0/val',
                      r'/home/liyuchen/YOLOX/YOLOX-OBB-main/datasets/DOTA_v1.0/val_split',
                      gap=200,        # �ص�����
                      subsize=1024,   # ���ָ�ɵ�СͼƬ��size
                      num_process=8
                      )
