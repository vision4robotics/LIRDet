...
if __name__ == '__main__':
    split = splitbase(r'/home/liyuchen/YOLOX/YOLOX-OBB-main/datasets/DOTA_v1.0/test/images',
                      r'/home/liyuchen/YOLOX/YOLOX-OBB-main/datasets/DOTA_v1.0/test/test_split')
    split.splitdata(1)