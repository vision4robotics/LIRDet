...
def main():
    ...
    #for DOTA_v1.0
    # detpath = r'/home/liyuchen/YOLOX/YOLOX-OBB-main/datasets/DOTA_v1.0/results/DOTA_v1.0_val_mosaic/{:s}.txt'
    # annopath = r'/home/liyuchen/YOLOX/YOLOX-OBB-main/datasets/DOTA_v1.0/val/labelTxt-v1.0/{:s}.txt'
    # imagesetfile = r'/home/liyuchen/YOLOX/YOLOX-OBB-main/datasets/DOTA_v1.0/val/val_name/val.txt'


    #for fastener-val
    detpath = r'/home/liyuchen/YOLOX/YOLOX-OBB-main/datasets/fastener/results/fastener_val_mosaic/{:s}.txt'
    annopath = r'/home/liyuchen/YOLOX/YOLOX-OBB-main/datasets/fastener/fastener/test/labelTxt/{:s}.txt'
    imagesetfile = r'/home/liyuchen/YOLOX/YOLOX-OBB-main/datasets/fastener/ImageSets/Main/val.txt'    
    ...
    #For fastener
    classnames = ['screw','pin','rivet','nut','gasket','bolt']
